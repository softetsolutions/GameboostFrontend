...
import { productInfo, otherSellers } from './dummyData.ts';
import type { ProductInfo, OtherSeller } from './dummyData.ts'; 
...
function BuyCardComp() {
  ...
  const { productTitle, DeliverySpeed, DeliveryMethod, ProductType, Denomination, Description, level, pricePerItem, productImg }: ProductInfo = productInfo;
  ...
  const totalAmount: string = (count * pricePerItem).toFixed(2);
    ...
    <div className="min-h-screen bg-gray-950 text-gray-200 pb-16 relative">
          ...
          <div className="p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 text-sm">
              <div>
                ...
                <p className="font-semibold text-gray-200">{DeliverySpeed}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 text-sm">
              <div>
                ...
                <p className="font-semibold text-gray-200">{ProductType}</p>
              </div>
              <div>
                <p className="text-gray-400">Denomination</p>
                <p className="font-semibold text-gray-200">{Denomination}</p>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center p-4 min-h-screen">
            <div id="box-1" className="shadow-lg p-6 w-full max-w-sm mb-6 bg-gray-900/80 backdrop-blur-lg rounded-2xl border border-gray-700">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-gray-400 text-sm">{level} available</h3>
      ...
      <div className="bg-gray-900/80 backdrop-blur-lg rounded-xl shadow-lg border border-gray-700 mb-6 max-w-7xl mx-auto py-8 px-4 lg:px-8 relative z-10">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-gray-100 mb-3 sm:mb-0">Other sellers ({filteredSellers.length})</h2>
