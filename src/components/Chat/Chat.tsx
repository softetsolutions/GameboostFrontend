...
export default function Chat() {
  ...
  return (
    <div className="flex h-screen text-white justify-center bg-gradient-to-b from-gray-800/60 to-gray-800/70 overflow-hidden">
                ...
                {showup && (
                  <>
                    <div className="border border-gray-800/40 bg-gray-700/20 p-1 mt-3  hover:bg-gray-700/40 ">
                      <button
                        onClick={() => {setactiveChat("Group1"); if (isSmallScreen()) {
                          setisOpen(true);}}}
                    ...
                    <div className="border border-gray-800/40 bg-gray-700/20 p-1 mt-3 hover:bg-gray-700/40">
                      <button
                        onClick={() => {setactiveChat("Group2"); if (isSmallScreen()) {
                          setisOpen(true);}}}
                        className=" flex flex-row text-gray-200 p-3 rounded-lg transition w-100 h-18 ml-6"
                      >
                        <div>
                    ...
                    <div className="border border-gray-800/40 bg-gray-700/20 p-1 mt-3  hover:bg-gray-700/40">
                      <button
                        onClick={() => {setactiveChat("Group3"); if (isSmallScreen()) {
                          setisOpen(true);}}}
                        className=" flex flex-row text-gray-200 p-3 rounded-lg  transition w-100 h-18 ml-6"
                      >
                        <div>
              ...
              {showDMtri && (
                <>
                  <div className=" group border border-gray-800/40 bg-gray-700/20 p-1 mt-3  hover:bg-gray-700/40">
                    <button
                      onClick={() => {setactiveChat("DM1"); if (isSmallScreen()) {
                        setisOpen(true);}}}
                      className=" flex flex-row text-gray-200 p-3 rounded-lg  transition w-100 h-18 ml-6"
                    >
                      <div>
                  ...
                  <div className="group border border-gray-800/40 bg-gray-700/20 p-1 mt-3  hover:bg-gray-700/40">
                    <button
                      onClick={() => {setactiveChat("DM2"); if (isSmallScreen()) {
                        setisOpen(true);}}}
                      className=" flex flex-row text-gray-200 p-3 rounded-lg  transition w-100 h-18 ml-6"
                    >
                      <div>
                  ...
                  <div className="group border border-gray-800/40 bg-gray-700/20 p-1 mt-3 hover:bg-gray-700/40">
                    <button
                      onClick={() => {setactiveChat("DM3"); if (isSmallScreen()) {
                        setisOpen(true);}}}
                      className=" flex flex-row text-gray-200 p-3 rounded-lg   transition w-100 h-18 ml-6"
                    >
                      <div>
      ...
      <div className={`flex flex-col w-lg sm:w-4xl h-screen  text-right border border-gray-600/90 bg-gradient-to-b from-gray-700/20 to-gray-800/70
