...
function BrowsingHistory() {
  ...
  if (history.length === 0) return null; // Don't show anything if history is empty
    ...
    <div className="flex justify-center px-4 py-8 ">
      <div className="w-full max-w-5xl p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl text-white font-bold w-[90%] text-center">Browsing History</h2>
          <button
            onClick={() => {
        ...
        <div className="flex flex-wrap gap-4 justify-start">
          {history.map((offer) => (
            ...
            >
              ...
              <div className="p-2 inset-0 bg-gradient-to-b from-transparent to-black/30 group-hover:opacity-50 text-white">
              <div className='flex justify-between'>

                <p className="text-sm font-medium">{offer.product?.title}</p>
                <p className="text-xs">{offer.price} {offer.currency}</p>
              </div>
